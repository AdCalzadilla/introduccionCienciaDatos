...
#### Friedman y como post- hoc Holm

Comparativas Múltiples – se usará Friedman y como post- hoc Holm (los rankings se calculan por posiciones de los algoritmos para cada problema y no hace falta normalización)
